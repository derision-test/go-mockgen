...
- Added basic support for generic interfaces. [#20](https://github.com/derision-test/go-mockgen/pull/20)
...
[Unreleased]: https://github.com/derision-test/go-mockgen/compare/v1.1.4...HEAD
